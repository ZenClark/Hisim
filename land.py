...
class Land(object):
    ...
    def iAgriculture(self, general):
        ...
        self.loyalty += 1
        #print self.name + '\'s agriculture went up by ' + str(amount) + ', increasing it to ' + str(self.agriculture) + '. \n'
        #print 'Improved by ' + general.name + '.\n'
        general.strength -= 10
        return amount
    ...
    def iMarket(self, general):
        ...
        amount = general.stats.Leadership()        
        #print self.name + '\'s market went up by ' + str(amount) + ', increasing it to ' + str(self.market) + '. \n'
        #print 'Improved by ' + general.name + '.\n'
        general.strength -= 10
        return amount
